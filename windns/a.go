...
func (c *Client) InsertA(host, name, zone, address string, ttl int) (r *dnsc.Msg, tt time.Duration, err error) {
...
func (c *Client) RemoveA(host, name, zone, address string, ttl int) (r *dnsc.Msg, tt time.Duration, err error) {
	req := fmt.Sprintf("%s %d A %s", FqdnJoin(name, zone), ttl, address)
...
func (c *Client) UpdateA(host, name, zone, oAddress, nAddress string, ttl int) (r *dnsc.Msg, tt time.Duration, err error) {
